...
#d=pd.read_csv("datasets/pendigits_ae_DEC.csv")

#d = pd.read_csv("datasets/coil100.csv")
#y = pd.read_csv("datasets/coil100_label.csv")

#d = pd.read_csv("datasets/USPS/usps_ae_CAE.csv")
#d = pd.read_csv("datasets/usps_ae_DEC.csv")
#y = pd.read_csv("datasets/USPS/usps_y.csv")

#d = pd.read_csv("datasets/MNIST/mnist_ae_DEC.csv")
...
#d = pd.read_csv("datasets/CIFAR10/cifar10_CAE.csv")
#d = pd.read_csv("datasets/CIFAR10/cifar10_resnet50.csv")
#d = pd.read_csv("datasets/CIFAR10/cifar10_resnet50_DEC.csv")
#d = pd.read_csv("datasets/CIFAR10/cifar10_vgg16.csv")
#d = pd.read_csv("datasets/CIFAR10/cifar10_vgg16_CAE.csv")
#d = pd.read_csv("datasets/CIFAR10/cifar10_vgg16_DEC.csv")
#y = pd.read_csv("datasets/CIFAR10/cifar10_y.csv")



#d = pd.read_csv("datasets/stl10_vgg16.csv")
#d = pd.read_csv("datasets/stl10_vgg16_ae_DEC.csv")
#d = pd.read_csv("datasets/STL/stl10_resnet50_CAE.csv")
#y = pd.read_csv("datasets/STL/stl10_y.csv")
#x=np.array(d)
...
embedding, y_pred1, centroids = ueccv.UEC_CV(n_neighbors=50, n_clusters=10, min_dist=0.0, verbose=True).fit_transform(d)

print('UEC-CV runtime: {} seconds'.format(time.time()-time_start))
...
print("Accuracy1 UEC-CV: ",acc1)
print("NMI UEC-CV: ",normalized_mutual_info_score(y, y_pred1))
...
def db_index(X, y):
    ...
    return dbi
dbi=db_index(embedding, y_pred1)
print("dbi= ", dbi)